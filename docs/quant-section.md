...
| `scripts/quant_factors.py` | Factor computation library (33 factors) |
...
- `quant_factors` — 33 seeded factors across 4 categories (price, volume, fundamental, technical)
...
## Factor Categories (33 total)

- **Price (10):** Momentum (1/3/6/12M), mean reversion (5/20D), volatility (20/60D), price/MA ratios
- **Volume (5):** Volume ratios, OBV slope, VWAP deviation, turnover rate
- **Fundamental (10):** PE, PB, PS, ROE, ROA, revenue/profit growth, D/E, dividend yield, market cap
- **Technical (8):** RSI, MACD, Bollinger, ATR, ADX, CCI, Stochastic, Williams %R
